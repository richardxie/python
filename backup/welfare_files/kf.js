...
var urlroot = "http://yulong.com/Public/Js/";
var tOut = -1;
var drag = false;
var g_safeNode = null;
lastScrollY = 0;
...
function kf_hide() 
{
	...
	if(document.getElementById("_Ten_rightDiv")){
...
function kf_getPopupDivHtml(kfguin,reference,companyname,welcomeword, wpadomain)
{
	...
	temp += '<div style="width:40px; height:159px;">';
...
//	temp += '<div style="float:left; width:74px; height:150px; background:url('+urlroot+'middle.jpg); background-position: center;">';
	...
	temp += '<div style="clear:both;"><a href="#" onclick="kf_openChatWindow(0,\''+wpadomain+'\',\''+kfguin+'\')" style="float:left; width:39px; height:135px; background:url('+urlroot+'middle.png); margin:0 0 0 2px; display:block;"></a></div></div>';
