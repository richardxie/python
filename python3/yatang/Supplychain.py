...
import yt, logging, traceback

logger = logging.getLogger('app')

from Borrow import Borrow
class Supplychain(Borrow): 
    ...
    def __repr__(self):
        return "<Supplychain(ibid='%s', type='%s', number='%s', minAmount='%f', cash='%f', hash_value='%s', uniqkey='%s', can_tender='%s')>" % (
    ...
    @staticmethod
    def supplyChainRequest(opener):
        resp = httpRequest(opener, yatang.YTURLBASESSL + "/Financial/supplychain")
